...
export default function LoginPage({ setAuth, setAdmin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      sessionStorage.setItem(ADMIN_SESSION_STARTED_AT_KEY, Date.now().toString());
      
      setAdmin(adminData);
      setAuth(true);

      // Always go to Dashboard after login — avoids stale 'next' param redirecting
      // admin to wrong page (e.g. scholarship page from a previous session).
