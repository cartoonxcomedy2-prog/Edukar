...
const getFileUrl = (fileName) => {
  ...
  // Prepend backend base URL for local files — keep /api prefix since
  // the server serves static files at /api/uploads (not /uploads directly)
  const server = (API.defaults.baseURL || '').replace(/\/+$/, '');
